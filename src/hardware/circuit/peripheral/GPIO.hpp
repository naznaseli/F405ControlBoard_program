...
public:
    typedef enum
    {
        ...
        PUSHPULL_AFPD   = 0b1000010,
        OPENDRAIN_AF    = 0b1010000,
        OPENDRAIN_AFPU  = 0b1010001,
        OPENDRAIN_AFPD  = 0b1010010,

        PUSHPULL        = 0b0100000,
        PUSHPULL_PU     = 0b0100001,
        PUSHPULL_PD     = 0b0100010,
        OPENDRAIN       = 0b0110000,
        OPENDRAIN_PU    = 0b0110001,
        OPENDRAIN_PD    = 0b0110010,
    ...
    //出力
    void setup(GPIO_TypeDef* gpio, uint8_t pin, PinMode pinMode, OutputSpeed outputSpeed);
